...
void main() {
  runApp(MaterialApp(
    home: HomeListaDeTarefa(),
  ));
}
class HomeListaDeTarefa extends StatefulWidget {
  @override
  _HomeListaDeTarefaState createState() => _HomeListaDeTarefaState();
}

class _HomeListaDeTarefaState extends State<HomeListaDeTarefa> {
        ...
        children: <Widget>[
          ...
          Expanded(
              ...
              child: RefreshIndicator(onRefresh: _refresh,
                child: ListView.builder(    // ListView é a lista e builder permite criar a lista conforme for construindo a mesma (estilo recyclerView)
  ...
  //Atualização demora apenas 1 segundo
  Future<Null>_refresh() async{
    await Future.delayed(Duration(seconds: 1));

    setState(() {
//Ordenando por tarefas nao realizadas na parte de cima
      _toDoList.sort((a, b){
